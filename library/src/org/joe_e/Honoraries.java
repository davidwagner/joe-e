...
public class Honoraries {
    ...
    static {
        ...
        entries.put(String.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        entries.put(Boolean.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        entries.put(Byte.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        entries.put(Short.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);    
        entries.put(Integer.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        entries.put(Long.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        entries.put(Float.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        entries.put(Double.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        entries.put(Character.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        entries.put(java.math.BigInteger.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        entries.put(java.math.BigDecimal.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        entries.put(Number.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_RECORD | IMPL_DATA);
        
        entries.put(Enum.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_EQUATABLE);
        
        entries.put(Class.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS | IMPL_EQUATABLE);
        
        entries.put(java.lang.reflect.Type.class, 
                    IMPL_IMMUTABLE | IMPL_POWERLESS);
        
        entries.put(Throwable.class, IMPL_IMMUTABLE | IMPL_POWERLESS);
        entries.put(Exception.class, IMPL_IMMUTABLE | IMPL_POWERLESS);
        // Add all untamed Throwables here.
    }
